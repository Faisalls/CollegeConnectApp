          ...
          children: [
            GestureDetector(
              onTap: () {
                Get.defaultDialog(
                    ...
                    middleText:
                        'i have an issue regardingrifmrunfrnfrufrfkmrfrmfmrrnmfuirmnfirmfrfrfnrfunur');
              },
              child: Align(
            ...
            Align(
              ...
              child: GestureDetector(
                  onTap: () {
                    Get.defaultDialog(
                      title: '...اهلا وسهلاً استاذ',
                      content: Text("هنا من المفترض تنعرض باقي شكوى المستخدم "),
                    );
                  },
